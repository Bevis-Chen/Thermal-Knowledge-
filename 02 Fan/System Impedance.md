...
實際伺服器的System Impedance Curve不僅是透過達西-魏斯巴赫公式描述，本篇的推導是簡化管路模型建立壓力損失與流量之間的關係。
我們綜合知道: 當流體流進一個管道或是管路甚至伺服器裡面，會因為內部管壁的摩擦、以及伺服器的散熱鰭片等等造成壓力損失。但是需要多少流量來克服壓力損失? 上述的公式推導告訴我們適當條件下 **ΔP 壓力損失可近似與 Q流量的平方成正比**。
