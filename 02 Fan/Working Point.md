...
從PQ Curve的說明我們知道P 大部分是代表靜壓、也就是產生壓差的能力; System Impedance Curve的P則是指壓力損失，代表系統內部的摩擦與局部阻力等等。System Impedance Curve所獲得的流量是風扇給的靜壓帶著機械能產生的全壓讓流體運動的表現，一開始空氣處於自由流動狀態、而風扇運轉，讓空氣帶著機械能流進伺服器內部。從靜壓到全壓，就差在風扇的運轉。
